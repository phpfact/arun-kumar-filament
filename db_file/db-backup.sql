...
CREATE TABLE `artist_channels` (
  ...
  `topic_channel_link` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `yt_channel_link` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `customers` (
  ...
  `label_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `email` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `password` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `remember_token` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dob` date DEFAULT NULL,
  `father_first_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `father_last_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mother_first_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mother_last_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `phone` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `whatsapp` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `aadhar_card_front` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `aadhar_card_back` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `pancard` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `plan` enum('free','gold') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'free',
...
(7, 'Arun', 'Kumar', 'Rock King Official', 'rockkibeat@gmail.com', '$2y$12$E/RwyXz.YD8uOPhA4cBfHuc0eDK4xlrbW.KTq4ooTP.8YEx4/G2ve', '7rUQst02WC7IHjiFTZyNGsGcakCMxxN7Jx7odKQosLsG27F9kB795mvbp6zM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'free', 0, '2024-10-17 11:39:41', '2024-10-21 16:33:42'),
(8, 'Sunil', 'Kumar', NULL, 'Summyji07@gmail.com', '$2y$12$p.Fcd6Nvu2ZN.TDFbhdmA.CRYrdFJjdDKyxFqG3eLKunSaz6AFq2K', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'free', 0, '2024-10-18 13:44:14', '2024-10-18 13:44:14');
...
CREATE TABLE `customer_address` (
  `id` int NOT NULL,
  `customer_id` int NOT NULL,
  `address1` longtext COLLATE utf8mb4_general_ci,
  `address2` longtext COLLATE utf8mb4_general_ci,
...
CREATE TABLE `remove_copyright_requests` (
  ...
  `yt_video_link` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `songs` (
  ...
  `singers` longtext COLLATE utf8mb4_general_ci,
  `lyrics` longtext COLLATE utf8mb4_general_ci,
  `composer` longtext COLLATE utf8mb4_general_ci,
  `label_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `publisher` longtext COLLATE utf8mb4_general_ci,
  `copyright` longtext COLLATE utf8mb4_general_ci,
  ...
  `song_path` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `caller_tune_name` longtext COLLATE utf8mb4_general_ci,
  `caller_tune_duration` longtext COLLATE utf8mb4_general_ci,
  `explicit` tinyint(1) NOT NULL DEFAULT '0',
  `isrc_code` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `status` enum('pending','approved','rejected') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'pending',
  `reject_reason` longtext COLLATE utf8mb4_general_ci,
  `report_file` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
INSERT INTO `songs` (`id`, `customer_id`, `name`, `singers`, `lyrics`, `composer`, `label_name`, `publisher`, `copyright`, `instagram`, `release_date`, `languages`, `cover_photo`, `song_path`, `stream_store`, `fb_ig_music`, `yt_content_id`, `caller_tune`, `caller_tune_name`, `caller_tune_duration`, `explicit`, `isrc_code`, `status`, `reject_reason`, `report_file`, `reward`, `is_added`, `created_at`, `updated_at`) VALUES
(5, 7, 'Hello Sir', '[\"Rock King\"]', '[\"Rock King\"]', '[\"Rock King\"]', NULL, 'First Call Distribution India', 'First Call Distribution India', 'realrockking', '2024-10-17', '[\"Hindi\"]', 'uploads/cover_photos/01JAD87R5WN0HDB3X438CVKDBP.jpg', 'uploads/songs/01JAD87SD9EK0J2DY0ABMS0MBX.mp3', 1, 1, 1, 0, NULL, NULL, 0, 'INF512310575', 'approved', 'Your Aucio COver Art Not Perfect', NULL, 0, 0, '2024-10-17 12:46:32', '2024-10-20 04:27:34');
...
(1, 'Admin', 'arun@admin.com', NULL, '$2y$12$oMzP9pGbtq2ZfBvvQT/Nl.mmdwOkw48MmAQwFffM2rVyZeeEb.F0i', 'vYk4pC7FbYC5b2tspz4uCnEi8HPeGOLd2sQrerl0BMd72ubXDjiy6JlrIPHH', '2024-05-11 11:56:39', '2024-05-11 11:56:39');
