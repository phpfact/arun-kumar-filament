...
--
-- Host: localhost
-- Generation Time: Oct 24, 2024 at 03:24 PM
...
(1, 'AA', '1', 1, '2024-10-24 12:00:42', '2024-10-24 11:42:10'),
(2, 'BB', '0', 2, '2024-10-24 12:46:28', '2024-10-24 12:39:21'),
(3, 'CCC', '2', 3, '2024-10-24 12:46:35', '2024-10-24 12:46:07');
...
INSERT INTO `songs` (`id`, `customer_id`, `name`, `singers`, `lyrics`, `composer`, `label_name`, `label_id`, `publisher`, `copyright`, `instagram`, `release_date`, `languages`, `cover_photo`, `song_path`, `stream_store`, `fb_ig_music`, `yt_content_id`, `caller_tune`, `caller_tune_name`, `caller_tune_duration`, `explicit`, `isrc_code`, `status`, `reject_reason`, `report_file`, `reward`, `is_added`, `created_at`, `updated_at`) VALUES
...
(6, 1, 'Testing', '[\"test\"]', '[\"tttt\"]', '[\"eee\"]', NULL, 1, 'gfs', 'gre', 'ger', '2024-10-24', '[\"mmmm\"]', 'uploads/cover_photos/01JAZACCC0S189Y65J0BS99FKQ.jpg', 'uploads/songs/01JAZACCCA7Z7TXJQ17VBK439K.mp3', 1, 1, 1, 1, '[\"testing abc\",\"rtte\"]', '[\"444\",\"4554\"]', 1, NULL, 'pending', NULL, NULL, 0, 0, '2024-10-24 13:10:15', '2024-10-24 13:10:15');
