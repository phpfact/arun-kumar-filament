...
use App\Filament\Resources\VideoSongResource\Pages;
use Illuminate\Database\Eloquent\SoftDeletingScope;
use App\Filament\Resources\VideoSongResource\RelationManagers;
            ...
            ->schema([
                ...
                ->schema([
                    ...
                    Select::make('artists_id')
                        ...
                        //             Forms\Components\Hidden::make('customer_id')->default(fn ($record) => $record ? $record->customer_id : Auth::guard('customer')->user()->id),
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('youtube_link')
                    ->url(fn ($record) => $record->youtube_link ?? NULL, true)
                    ->color('info')
                    ->placeholder('N/A')
                    ->label('YouTube Link'),
            ...
            ->bulkActions([
                ...
                ExportBulkAction::make()->exporter(\App\Filament\Exports\AdminVideoResourceExporter::class),
